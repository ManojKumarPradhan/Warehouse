...
<body>
	...
	<div align="center">
		<header style="width: 650px; font-size: 40px; font-weight: bold;">Shipment
			Type Edit Page</header>
		<table
			style="background-color: #E0FFFF; width: 650px; border-bottom-left-radius: 25px; border-bottom-right-radius: 25px;">
			<form:form action="update" method="POST"
				...
				<tr style="height: 50px">
					...
					<td style="width: 55%" align="left"><form:select path="mode">
						...
						</form:select> <br> <form:errors path="mode" cssClass="err" /></td>
				</tr>
				<tr style="height: 50px">
				...
				<tr style="height: 50px">
					...
					<td style="width: 55%" align="left"><form:checkbox
							path="enabled" value="Yes" />Yes <br> <form:errors
							path="enabled" cssClass="err" /></td>
				</tr>
				<tr style="height: 50px">
