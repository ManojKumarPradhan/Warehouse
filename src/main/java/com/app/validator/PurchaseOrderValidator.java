...
public class PurchaseOrderValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (purchaseOrder.getShipmentType() == null || purchaseOrder.getShipmentType().getId() == null) {
			errors.rejectValue("shipmentType", null, "Please Select One Shipment Type");
		}
		if (purchaseOrder.getWhUserType() == null || purchaseOrder.getWhUserType().getId() == null) {
